...
PERFORMANCE = [
    ...
    ["PT-001", "Single-dispatcher E2E", "200k packets, 100k generated SPI flows",
     ...
     "make benchmark-e2e",
     "6.43 Mpps; zero loss; 100k active flows",
    ...
    ["PT-002", "Multi-RX E2E", "2 RX queues, 2 dispatchers, 4 workers",
     ...
     "make benchmark-e2e",
     "9.57 Mpps; 1.49x over single-dispatcher PCAP", "PASS",
    ...
    ["PT-003", "Flow creation rate", "100k unique flows in E2E PCAP",
     ...
     "make benchmark-e2e",
     "3.22 Mflows/s single PCAP; 4.79 Mflows/s multi-RX; delete/timeout=0/s",
