...
PERFORMANCE = [
    ...
    ["PT-001", "Single-dispatcher E2E", "200k packets, 100k generated SPI flows",
     "PPS and loss", "processed=dispatched; no unexpected drop",
     "make benchmark-e2e",
     "5.46 Mpps; zero loss; 100k active flows",
    ...
    ["PT-002", "Multi-RX E2E", "2 RX queues, 2 dispatchers, 4 workers",
     ...
     "make benchmark-e2e",
     "7.24 Mpps; 1.33x over single-dispatcher PCAP", "PASS",
    ...
    ["PT-003", "Flow creation rate", "100k unique flows in E2E PCAP",
     ...
     "make benchmark-e2e",
     "2.73 Mflows/s single PCAP; 3.62 Mflows/s multi-RX; delete/timeout=0/s",
     "PASS", "Current CPU field is lcore allocation: 5/8 and 7/8 logical CPUs"],
    ["PT-004", "Realtime CLI benchmark", "PCAP PMD with infinite_rx=1",
     "Live PPS/flows/drops", "CLI updates while pipeline is running",
     "scripts/run_cli_pcap.sh then show benchmark",
     "Command implemented; manual visual check required", "READY",
     "show dashboard also renders Active Flow, Throughput, Packet Drop graphs"],
