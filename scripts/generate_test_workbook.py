...
PERFORMANCE = [
    ...
    ["PT-005", "End-to-end pipeline", "1M packets, 100k generated SPI flows",
     "PPS and loss", "processed=dispatched; no unexpected drop",
     "make benchmark-e2e", "1.95 Mpps single PCAP; 2.63 Mpps multi-RX PCAP; zero loss",
     "PASS", "2 warmup + 5 measured runs; median PPS; 4 active workers"],
