...
PERFORMANCE = [
    ...
    ["PT-001", "One-core baseline", "32,768 flows/worker, 2M packets",
     "PPS", "Record baseline", "make benchmark", "8.08 Mpps", "PASS",
     "i5-8250U; no hugepages; synthetic flow engine"],
    ["PT-002", "Two-core scale", "Same workload per worker", "Scale-up",
     ">=1.6x on laptop; >=1.8x on server", "make benchmark", "1.78x / 14.34 Mpps",
    ...
    ["PT-004", "Hot-cache scale", "4,096 flows/worker, 5M packets",
     ...
     "9.77 / 17.32 / 22.88 Mpps", "PASS", ""],
    ["PT-005", "End-to-end pipeline", "1M packets, 100k bidirectional flows",
     "PPS and loss", "processed=dispatched; no unexpected drop",
     "See README run command", "2.84 Mpps median; zero loss", "PASS",
     "Untagged subnet resolver; single dispatcher plus four workers"],
